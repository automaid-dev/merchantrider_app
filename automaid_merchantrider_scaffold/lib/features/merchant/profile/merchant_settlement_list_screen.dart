...
import 'merchant_settlement_receipt_screen.dart';

/// List of every settlement (payout) this merchant has ever received —
/// wraps POST /merchant/settlement/list (Api/Merchant/SettlementController::list).
/// Tapping a row opens the full receipt, viewable and downloadable as
/// a PDF.
class MerchantSettlementListScreen extends ConsumerWidget {
  const MerchantSettlementListScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final settlementsAsync = ref.watch(merchantSettlementListProvider);
      ...
      body: settlementsAsync.when(
        ...
        data: (settlements) {
          ...
          return RefreshIndicator(
            onRefresh: () async => ref.invalidate(merchantSettlementListProvider),
                  ...
                  child: ListTile(
                    ...
                    onTap: hashslug == null
                        ...
                        : () => Navigator.of(context).push(
                              MaterialPageRoute(
                                builder: (_) => MerchantSettlementReceiptScreen(hashslug: hashslug),
                              ),
                            ),
                  ),
                );
