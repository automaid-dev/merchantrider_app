...
/// eager-loads wallet.transactions and activities. Editing profile fields
/// (name, IC, address, emergency contact, bank info + avatar) needs a
/// multipart form — see RiderRepository doc comment on profileUpdate for
/// the full field list; not built yet, this screen is read-only.
